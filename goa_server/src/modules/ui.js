...
export const getValue = createAction(GET_VALUE, WebAPI.getValue);
...
export default handleActions({
    ...
    ...pender({
        ...
        onSuccess: (state, action) => {
            ...
            const {arrX, arrY, zoom} = meta;
            state.setIn(['values', 'lat', zoom - 3, arrX, arrY], fromJS(data[0])).setIn(['values', 'lon', zoom - 3, arrX, arrY], fromJS(data[1]));
        }
    })
}, initialState);